...
public class SuiXinZhiDaiDKJE implements KeywordStrategy{
    private static final String[] KEYWORDS = {"随心智贷贷款金额","随心智贷用款金额","随心自带贷款金额","随心自带用款金额"};
